    ...
    <PageModel name="Oops" title="Oops">
      <ErrorWrapper>
        <article>
          ...
          <p> You can return to our homepage by clicking <AniLink fade to="/">here</AniLink>.</p>
        </article>
      </ErrorWrapper>
    </PageModel>
  )
...
& article p {
  ${setFont({size: "15px", height: "27px", color: "#5c5c5c", weight: "300"})};
}

& article h1.oops{
  ${setFont({size: "45px", height: "1.2em", color: "#222222", weight: "300"})};
} 
& article li {
  margin-left: 40px;
}
