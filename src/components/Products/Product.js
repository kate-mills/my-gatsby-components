...
const Product = ({ product }) => {
  const {type, slug, name, skinType, description, imgRetail, ingredients} = product
  return (
    <ProductWrapper>
    ...
    <div className="img-container">
      <Image objectFit="contain" fluid={imgRetail.fluid} className="img" alt={imgRetail.description}/>
      <AniLink fade className="link" to={`/${type}/${slug}`} >watch video</AniLink>
    </div>
...
& h2.mcc-h2{${setFont({size: "30px", height: "42px", color:"#b30000cc", weight: "400"})}; padding: 0;}
